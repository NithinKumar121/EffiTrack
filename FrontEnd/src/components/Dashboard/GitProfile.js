        ...
        <div className='flex flex-col gap-x-8  mt-2'>
            <div className='w-full'>
                <div className='w-[40%] mx-auto'>
                    <Link to={`https://github.com/${GithubProfile.name}`}><img src={GithubProfile.avatar_url} alt='github' className='rounded-[100%] shadow-lg'></img></Link>
                </div>
            </div>
            <div className='flex flex-col gap-y-3 mt-4'>
                ...
                <p className='font-semibold ml-2'>Followers        : {GithubProfile.followers}</p>
                <p className='font-semibold ml-2'>Following        : {GithubProfile.following}</p>
                <p className='font-semibold ml-2'>Public Repos     :  {GithubProfile.public_repos}</p>
                <p className='font-semibold ml-2'>Public Gists     :  {GithubProfile.public_gists}</p>
            </div>
        </div>
    </div>
  )
