...
const Leftnav = (props) => {
  ...
  return (
    <aside
      className={`w-[60%] sm:w-auto text-[#f3f3f3] bg-[#000] dark:bg-[#1d1d1d] h-[100vh]  lg:block lg:relative ${mobileScreenNav ? "fixed left-0 z-10" : "hidden"} overflow-hidden scrollbar-hide`}
    >
      <div className="top">
        <div className="logo">
          <img
        ...
        <div className="close">
          <button
            onClick={() => dispatch(toggleLeftMobileNav(!mobileScreenNav))}
          >
      ...
      <div className="mt-[3rem]">
        <div className="mid-container">
          <div className="left-nav-link">
            <Link to={"/"}>
              <button
                className={`left-nav-a group ${activeButton == "page1" ? "l-nav-a-active" : ""}`}
          ...
          <div className="left-nav-link">
            <Link to={"/profile"}>
              <button
                className={`left-nav-a group ${activeButton == "page2" ? "l-nav-a-active" : ""}`}
          ...
          <div className="left-nav-link">
            <Link to={"/usernameSearch"}>
              <button
                className={`left-nav-a group ${activeButton == "page3" ? "l-nav-a-active" : ""}`}
          ...
          <div
            className={`${!mobileScreenNav ? "hidden" : "left-nav-link w-[80%] mx-auto"} `}
          >
            <Theme />
          </div>
        </div>
