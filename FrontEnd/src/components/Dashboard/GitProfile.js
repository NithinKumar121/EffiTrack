...
const GitProfile = ({modify}) => {
  return (
    <div className='flex flex-col px-4 gap-2 relative mt-3'>
        <div className="h-[2.5rem] mt-[0.2rem] flex"> <h1 className={`${modify.topic} h-full w-[8rem] rounded-3xl flex items-center p-0 pl-2 text-lg font-semibold justify-center dark:bg-[#333] dark:text-[#f3f3f3]`}>
            <div>
                GitHub
            </div>
        </h1></div>
